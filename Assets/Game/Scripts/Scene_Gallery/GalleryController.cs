...
public class GalleryController : MonoBehaviour
{
    ...
    /// <summary>
    /// При соблюдении порядка нумерации в галлерею подгрузятся все существующие по линку картинки в формате jpg. 
    /// Нарушение порядка остановит создание коллекции. 
    /// </summary>
    /// <returns></returns>
